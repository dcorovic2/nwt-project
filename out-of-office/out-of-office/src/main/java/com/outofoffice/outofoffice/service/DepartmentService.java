...
public class DepartmentService {
	...
	public Department getById(Long id) {
		...
		return departmentRepository.findById(id)
				.orElseThrow(() -> new NotFoundException(id_string, "Department", "id", ""));
	}
	...
	public Department getByCode(String code) {
		try {
			...
			if (department == null)
				throw new NotFoundException("", "Department", "code", code);
			return department;
		} catch (Exception e) {
	...
	public Long deleteDepartment(Long department_id) {
		String id_string = department_id + "";
			Department departmentForDelete = departmentRepository.findById(department_id).orElseThrow(() -> new NotFoundException(id_string, "Department", "id", ""));
		try {
	...
	public Department updateDepartment(Department departmentRequest, Long id) {
		String id_string = id + "";
		Department updated_department = departmentRepository.findById(id)
				.orElseThrow(() -> new NotFoundException(id_string, "Department", "id", ""));
		try {
