...
class EmployeeControllerTest {
	...
	private EmployeeRequest createTestEmployee() throws Exception {
		EmployeeRequest employee_req = new EmployeeRequest("21", "test@gmail.com", "testname", OffsetDateTime.now(),
				"9999999999999", "jobRole1", "phoneNumber1", 21, 1L, 2L);
	...
	void testEmployeeWrongDataPOST() throws Exception {
		EmployeeRequest employee_req = new EmployeeRequest("21", "test@gmail.com", "ime prezime", OffsetDateTime.now(),
				"rr", "jobRole1", "phoneNumber1", 21, 1L, 2L);
		this.mockMvc.perform(MockMvcRequestBuilders.post("/employee").contentType("application/json")
	...
	public void testPutEmployeeeDepartmentWrongiDPUT() throws Exception {
		EmployeeRequest employee_req = new EmployeeRequest("21", "test@gmail.com", "testname", OffsetDateTime.now(),
				"9999999999999", "jobRole1", "phoneNumber1", 21, 15L, 2L);
		this.mockMvc
